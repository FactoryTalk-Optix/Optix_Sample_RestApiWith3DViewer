...
public class RuntimeNetLogic1 : BaseNetLogic
{
    ...
    public void GetStarWarsShips(int id)
    {
        ...
        string url = $@"https://swapi.py4e.com/api/starships/{id}/";
    ...
    private void ColorChange()
    {
        ...
        string templatePath = new ResourceUri(LogicObject.GetVariable("TempJs").Value).Uri;
        string filePath = new ResourceUri(LogicObject.GetVariable("DestJs").Value).Uri;
